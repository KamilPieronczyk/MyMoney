...
export class RemotePaymentScreen extends Component {
  constructor(props){
    super(props);
    ...
    this.state = {
      ...
      accountName: this.props.navigation.getParam('username'),
      date: dateString,
      time: timeString,
      ...
      paymentRoomId: this.props.navigation.getParam('paymentRoomId'),
      backgroundColor: '#fff',
      progressBar: false,
    }
    let currentUser = firebase.auth().currentUser;
    console.log(this.state.paymentRoomId);
    this.payment = firebase.firestore().collection('paymentsRooms').doc(this.state.paymentRoomId).collection('payments').doc(this.state.paymentId);
